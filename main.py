...
# init parameters
parser.add_argument('--fast_swap', type=str2bool,
                    default=True, help="whether use fast swap scheme.")
...
parser.add_argument('--vgg19_model_path', type=str,
                    default='his_model/VGG19/imagenet-vgg-verydeep-19.mat')
...
parser.add_argument('--w_tex', type=float, default=1e-4,
                    help='weight of texture loss between output and texture map')
parser.add_argument('--w_adv', type=float, default=1e-6,
                    help='weight of adversarial loss')
parser.add_argument('--w_bp', type=float, default=0.0,
                    help='weight of back projection loss')
...
parser.add_argument('--is_WGAN_GP', type=str2bool,
                    default=True, help='whether use WGAN-GP')
parser.add_argument('--is_L1_loss', type=str2bool,
                    default=True, help='whether use L1 norm')
parser.add_argument('--param_WGAN_GP', type=float,
                    default=10, help='parameter for WGAN-GP')
parser.add_argument('--input_size', type=int, default=80,
                    help='be careful! size of input(not inputSU)')
parser.add_argument('--use_weight_map', type=str2bool, default=False)
parser.add_argument('--use_lower_layers_in_per_loss',
...
parser.add_argument('--x2_train', action='store_true',
                    help='train or test a 2x model')
parser.add_argument('--result_dir', type=str, default='result',
                    help='dir of saving testing results')
    ...
    if not many_test:
        ...
        for filename in inputs:
            ...
            if os.path.exists(path_r):
                ...
                print('filename %s not exists in %s, not processed!' %
